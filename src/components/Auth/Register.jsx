...
const Register = () => {
  ...
  const handleOpenGoogleModal = () => {
    setError('');
    setGoogleEmail(formData.email.trim() ? formData.email.trim() : '');
    setGoogleName(formData.full_name || '');
  ...
  const handleConfirmGoogleSignIn = async (e) => {
    ...
    try {
      const googleUserPayload = {
        ...
        full_name: googleName.trim() || formData.full_name || googleEmail.split('@')[0],
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '1rem' }}>
              ...
              <h3 style={{ margin: 0, fontSize: '1.25rem', fontWeight: 800 }}>Sign up with Google</h3>
            </div>
            <p style={{ fontSize: '0.88rem', color: '#64748b', marginBottom: '1.25rem' }}>
              Choose or enter your Google account email address to register with NeoLearner.
            </p>
